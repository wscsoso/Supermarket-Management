    ...
    <div style="margin: 200px auto; background-color: #fff; width: 350px; height: 350px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item style="margin: 10px 0; text-align: right">
          ...
          <el-button type="warning" size="small"  autocomplete="off"  @click="$router.push('/login')">已有账号?</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
...
<style>
  .wrapper {
    height: 100vh;
    background-image: linear-gradient(to bottom right, rgb(249, 197, 236) , rgb(168, 192, 238));
    overflow: hidden;
  }
</style>
